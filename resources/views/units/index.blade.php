...
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #10b981, #059669);">
            ...
            <h2 class="mb-0 fw-bold display-5 text-white">{{ number_format($totalUnit) }}</h2>
    ...
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #3b82f6, #2563eb);">
            ...
            <h2 class="mb-0 fw-bold text-white text-truncate" style="font-size:2.2rem; line-height:1.2; padding-top:4px;">{{ $latestUnit ?: '-' }}</h2>
