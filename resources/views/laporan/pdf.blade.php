...
<body>
    ...
    <div style="page-break-before: always;">
        ...
        <table style="width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td class="font-bold">{{ $arsip->no_registrasi ?? '-' }}</td>
                    <td>{{ $arsip->tgl_pengajuan ? $arsip->tgl_pengajuan->format('d/m/Y') : '-' }}</td>
                    <td>{{ str_replace('_', ' ', $arsip->jenis_pengajuan) }}</td>
                    <td class="text-left">
                        <div style="font-weight: bold;">{{ $arsip->admin->name ?? 'System' }}</div>
                    ...
                    <td>
                        <span style="color: {{ $arsip->arsip == 'Done' ? '#16a34a' : '#6b7280' }};">
                            {{ $arsip->arsip == 'Done' ? 'OK' : 'Pending' }}
                        </span>
                    </td>
                    <td>
                        <span style="
                            font-weight: bold;
                            color: {{ $arsip->status == 'Done' ? '#16a34a' : ($arsip->status == 'Reject' ? '#dc2626' : '#d97706') }};
                        ">
    ...
    <div class="footer">
        Generated by IT Submission System | {{ now()->format('d M Y H:i') }}
    </div>
