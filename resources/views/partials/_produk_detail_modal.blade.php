{{-- Modal Detail Produk Baru: barcode, tanggal dibuat, last modify, log perubahan.
     Include dengan: @include('partials._produk_detail_modal', ['detailBase' => url('superadmin/arsip')]) --}}
