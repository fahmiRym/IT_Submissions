                    ...
                    <form method="POST" action="{{ route('superadmin.users.store') }}">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="password" name="password"
                                    class="form-control premium-input @error('password') is-invalid @enderror" required
                                    placeholder="••••••••">
                                <div class="text-muted" style="font-size: 0.7rem; margin-top: 0.4rem;">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role" class="form-select premium-input @error('role') is-invalid @enderror"
                                    required>
                        ...
                        <div class="mb-5">
                            ...
                            <select name="department_id"
                                class="form-select premium-input @error('department_id') is-invalid @enderror" required>
