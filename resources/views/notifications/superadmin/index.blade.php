        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
                @if($paginatedNotifications->count() > 0)
                    ...
                    <form action="{{ route('superadmin.notifications.mark-all-read') }}" method="POST" class="d-inline">
                        @csrf
                    ...
                    <form action="{{ route('superadmin.notifications.clear-all') }}" method="POST" class="d-inline"
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex gap-2 mt-2">
                                    ...
                                    @if($n->arsip_id)
                                        <a href="{{ route('superadmin.arsip.index', ['search' => $n->arsip->no_registrasi ?? $n->arsip->no_doc]) }}" 
