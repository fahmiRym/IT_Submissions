    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-body p-4 text-center">
                ...
                <h3 class="fw-bold text-dark mb-3">{{ $stats['disk_used_percent'] }}% <small class="text-muted" style="font-size: 0.8rem;">Used</small></h3>
                <div class="progress rounded-pill mb-3" style="height: 10px;">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $stats['disk_used_percent'] }}%"></div>
                </div>
                <div class="d-flex justify-content-between small">
                    <span class="text-muted">Free: {{ $stats['disk_free'] }}</span>
                    <span class="text-muted">Total: {{ $stats['disk_total'] }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card border-0 shadow-sm rounded-4 h-100">
            <div class="card-body p-4 text-center">
                ...
                <h3 class="fw-bold text-dark mb-1">{{ $stats['database_size'] }}</h3>
            ...
            <div class="card-body p-4">
                ...
                <div class="list-group list-group-flush">
                    <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-center border-0">
                        ...
                        <span class="badge bg-light text-dark border">{{ $stats['php_version'] }}</span>
                    </div>
                    <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-center border-0">
                        <span class="text-muted">Laravel Framework</span>
                        <span class="badge bg-light text-dark border">v{{ $stats['laravel_version'] }}</span>
                    </div>
                    <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-center border-0">
                        <span class="text-muted">Operating System</span>
                        <span class="badge bg-light text-dark border">{{ $stats['os'] }}</span>
                    </div>
                    <div class="list-group-item px-0 py-2 d-flex justify-content-between align-items-center border-0">
                        <span class="text-muted">Web Server</span>
                        <span class="badge bg-light text-dark border text-truncate" style="max-width: 150px;">{{ $stats['server_software'] }}</span>
                    </div>
                </div>
            </div>
        </div>
