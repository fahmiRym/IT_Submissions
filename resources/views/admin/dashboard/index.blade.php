...
@section('content')
    ...
    <div class="row g-3 g-lg-4 mb-4">
        ...
        <div class="col-6 col-lg-3">
            <a href="{{ route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Review'])) }}"
        ...
        <div class="col-6 col-lg-3">
            <a href="{{ route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Process'])) }}"
                class="text-decoration-none h-100 d-block">
        ...
        <div class="col-6 col-lg-3">
            <a href="{{ route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Done'])) }}"
                class="text-decoration-none h-100 d-block">
    ...
    <div class="row g-2 g-md-3 mb-4">
        ...
        @foreach($proc as $p)
            <div class="col-6 col-sm-4 col-lg-2">
                <a href="{{ route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => $p['db']])) }}"
                    class="text-decoration-none h-100 d-block">
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-md-4">
            <a href="{{ route('admin.arsip.index', ['jenis' => 'Produk_Baru']) }}" class="text-decoration-none h-100 d-block">
        ...
        <div class="col-6 col-md-4">
            <a href="{{ route('admin.arsip.index', ['jenis' => 'Produk_Baru', 'ket_process' => 'Done']) }}" class="text-decoration-none h-100 d-block">
        ...
        <div class="col-6 col-md-4">
            <a href="{{ route('admin.arsip.index', ['jenis' => 'Produk_Baru', 'ket_process' => 'Process']) }}" class="text-decoration-none h-100 d-block">
    ...
    <div class="row g-2 g-md-3 mb-4">
        ...
        @foreach($cats as $c)
            <div class="col-6 col-sm-4 col-lg-2">
                <a href="{{ route('admin.arsip.index', array_merge(request()->all(), ['jenis_pengajuan' => $c['code']])) }}"
                    class="text-decoration-none h-100 d-block">
                    <div class="card-category h-100 p-2 p-md-3">
                        ...
                        <div class="small fw-bold text-muted mb-1 text-uppercase" style="font-size: 0.55rem;">{{ $c['label'] }}
                        </div>
                        <div class="cat-count" style="color: {{ $c['color'] }}; font-size: 1.2rem;">
                            {{ number_format($c['val']) }}</div>
                    </div>
                </a>
            </div>
        @endforeach
                        ...
                        <tr>
                            <td class="ps-4">
                                ...
                                <div class="small text-muted"><i
                                        class="bi bi-clock me-1 text-primary opacity-75"></i>{{ optional($a->created_at)->format('H:i') }}
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="d-none d-lg-table-cell">
                                ...
                                <span class="px-3 py-1 rounded-pill fw-bold"
                                    style="font-size:0.68rem; background:{{ $jc['bg'] }}; color:{{ $jc['text'] }}; border:1px solid {{ $jc['text'] }}20;">
                            ...
                            <td>
                                ...
                                <div class="px-3 py-1 rounded-pill fw-bold d-flex align-items-center gap-2"
                                    ...
                                    <div class="rounded-circle" style="width:6px;height:6px;background:{{ $kpC['dot'] }};">
                                    </div>
                                ...
                                <div class="d-flex flex-column gap-1 align-items-end" style="min-width:200px;">
                                    ...
                                    @if($a->adjustItems->count() > 2 || $a->mutasiItems->count() > 2)
                                        <small class="text-primary fw-bold mt-1"
                                            style="font-size:.64rem;">+{{ max($a->adjustItems->count(), $a->mutasiItems->count()) - 2 }}
                                            lainnya</small>
                                    @endif
                                </div>
                            </td>
