...
<?php $__env->startSection('page-title', '🔔 Notifikasi Saya'); ?>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <?php if($n->arsip): ?>
                                    <div class="bg-light rounded p-2 border d-inline-block mt-1 mb-2">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 text-xs mt-1">
                                            ...
                                            ?>
                                            <span class="badge bg-<?php echo e($statusColor); ?> bg-opacity-10 text-<?php echo e($statusColor); ?> border border-<?php echo e($statusColor); ?>">
                                                <?php echo e(ucfirst($n->arsip->ket_process)); ?>
                                ...
                                <div class="d-flex gap-2 mt-2">
                                    <?php if(!$n->is_read): ?>
                                        <form method="POST" action="<?php echo e(route('admin.notifications.read', $n->id)); ?>">
                                    ...
                                    <?php if($n->arsip_id): ?>
                                        <a href="<?php echo e(route('admin.arsip.index', ['search' => $n->arsip->no_registrasi ?? $n->arsip->no_doc])); ?>" 
