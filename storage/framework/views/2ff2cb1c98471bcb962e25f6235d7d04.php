            ...
            <div class="card-body p-0 pb-4">
                <div class="avatar-wrapper">
                    <div class="avatar-circle">
                        <?php if($user->photo): ?>
                            <img src="<?php echo e(asset('profile_photos/' . $user->photo)); ?>" alt="Profile Photo" class="avatar-img" id="currentPhoto">
                        <?php else: ?>
                            <div class="avatar-inner" id="avatarInitial">
                                <?php echo e(substr(strtoupper($user->name), 0, 1)); ?>
                    ...
                    <div class="mt-3">
                        <h4 class="fw-bold text-dark mb-0"><?php echo e($user->name); ?></h4>
                        ...
                        <div class="d-flex flex-wrap justify-content-center gap-2 mb-2">
                            ...
                            <div class="role-badge" style="background: #f8fafc; color: #64748b; border-color: #e2e8f0;">
                                <i class="bi bi-building me-1"></i> <?php echo e($user->department->name); ?>
                ...
                <div class="px-4 py-3">
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            <div class="stat-box">
                                <div class="stat-value text-success"><?php echo e($stats['done']); ?></div>
                        ...
                        <div class="col-6">
                            <div class="stat-box">
                                <div class="stat-value text-info"><?php echo e($stats['process']); ?></div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Nama Anda" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" 
                                   class="form-control premium-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="email@contoh.com" required>
                    ...
                    <div class="security-section">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="password" name="password" class="form-control premium-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Minimal 6 karakter">
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php echo $__env->make('partials._signature_specimen', ['action' => route('admin.profile.signature')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function cancelPhotoUpload() {
        ...
        // Restore
        <?php if($user->photo): ?>
            if (currentPhoto) currentPhoto.src = "<?php echo e(asset('profile_photos/' . $user->photo)); ?>";
        <?php else: ?>
            if (currentPhoto) currentPhoto.outerHTML = `<div class="avatar-inner" id="avatarInitial"><?php echo e(substr(strtoupper($user->name), 0, 1)); ?></div>`;
        <?php endif; ?>
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\admin\profile\index.blade.php ENDPATH**/ ?>