...
<head>
    <meta charset="utf-8">
    <title>Print Draft Bundel - <?php echo e($arsip->no_registrasi); ?></title>
...
<div class="print-container">
    ...
    <?php for($k = 0; $k < $displayFormCount; $k++): ?>
        <?php
        ...
        <div class="form-block">
            <div class="wrapper">
                ...
                <table class="header-table">
                    <tr>
                        ...
                        <td style="width: 25%; padding: 4px; vertical-align: top;">
                            ...
                            <div id="qrcode-<?php echo e($k); ?>" style="margin-top: 3px;"></div>
                        </td>
                        ...
                        <td style="width: 50%; text-align: center; vertical-align: middle; padding: 4px;">
                            ...
                            <div style="font-size: 8px; color: #555; margin-top: 2px;">
                                Form <?php echo e($k + 1); ?> dari <?php echo e($displayFormCount); ?>
                ...
                <div class="date-row">
                    Tanggal : <b><?php echo e(\Carbon\Carbon::parse($arsip->tgl_pengajuan)->format('d-m-Y')); ?></b>
                    &nbsp;&nbsp;&nbsp;
                    Pemohon : <b><?php echo e(strtoupper($arsip->pemohon ?? $arsip->admin->name ?? '-')); ?></b>
                </div>
                ...
                <table class="main-table">
                    ...
                    <tbody>
                        <?php for($i = 0; $i < 5; $i++): ?>
                            <?php $item = $currentItems->values()->get($i); ?>
                            <tr>
                                <td><?php echo e($i + 1); ?></td>
                                <td><?php echo e($item->no_doc ?? ''); ?></td>
                                <td></td>
                                <td></td>
                ...
                <div class="signature">
                    <div class="sig-box">
                        ...
                        <div class="sig-name"><?php echo e(ucwords(mb_strtolower($arsip->admin->name ?? ''))); ?></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        <?php for($k = 0; $k < 9; $k++): ?>
        if (document.getElementById('qrcode-<?php echo e($k); ?>')) {
            new QRCode(document.getElementById('qrcode-<?php echo e($k); ?>'), {
...
</html><?php /**PATH C:\laragon\www\e_arsip\resources\views\print\arsip_draft_bundel.blade.php ENDPATH**/ ?>