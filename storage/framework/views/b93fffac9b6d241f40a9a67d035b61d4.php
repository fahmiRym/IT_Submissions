...
<?php $__env->startSection('title', 'Dashboard Admin | IT Submission'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <select name="unit_id" class="form-select bg-light border-0 py-2 rounded-3 shadow-none">
                        ...
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($u->id); ?>" <?php echo e(request('unit_id') == $u->id ? 'selected' : ''); ?>><?php echo e($u->name); ?>
    ...
    <div class="row g-3 g-lg-4 mb-4">
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.arsip.index', request()->all())); ?>" class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-indigo h-100 p-3 p-lg-4">
                    <h6 class="text-white-50 text-uppercase small fw-bold mb-2" style="font-size: 0.65rem;">Total Pengajuan
                    </h6>
                    <h2 class="mb-0 fw-bold display-6 text-white"><?php echo e(number_format($total)); ?></h2>
                    <div class="mt-2 text-white-50 small font-monospace d-none d-sm-block"><i
                            class="bi bi-layers-fill me-1"></i> ALL SUBMISSION</div>
                    <i class="bi bi-layers-fill stat-overlay-icon"></i>
                </div>
            </a>
        </div>
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Review']))); ?>"
                ...
                <div class="card-stat-vibrant bg-gradient-blue h-100 p-3 p-lg-4">
                    ...
                    <h2 class="mb-0 fw-bold display-6 text-white"><?php echo e(number_format($Review)); ?></h2>
                    <div class="mt-2 text-white-50 small font-monospace d-none d-sm-block"><i
                            class="bi bi-clock-history me-1"></i> WAITING</div>
                    <i class="bi bi-clock-history stat-overlay-icon"></i>
                </div>
            </a>
        </div>
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Process']))); ?>"
                class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-orange h-100 p-3 p-lg-4">
                    ...
                    <h2 class="mb-0 fw-bold display-6 text-white"><?php echo e(number_format($process)); ?></h2>
                    <div class="mt-2 text-white-50 small font-monospace d-none d-sm-block"><i
                            class="bi bi-gear-fill me-1"></i> ON GOING</div>
                    <i class="bi bi-gear-fill stat-overlay-icon"></i>
                </div>
            </a>
        </div>
        <div class="col-6 col-lg-3">
            <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Done']))); ?>"
                class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-green h-100 p-3 p-lg-4">
                    ...
                    <h2 class="mb-0 fw-bold display-6 text-white"><?php echo e(number_format($done)); ?></h2>
                    <div class="mt-2 text-white-50 small font-monospace d-none d-sm-block"><i
                            class="bi bi-check-circle-fill me-1"></i> FINALIZED</div>
    ...
    <div class="row g-2 g-md-3 mb-4">
        ...
        ?>
        <?php $__currentLoopData = $proc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-6 col-sm-4 col-lg-2">
                <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => $p['db']]))); ?>"
                    class="text-decoration-none h-100 d-block">
                    <div class="card-pipeline <?php echo e($p['color']); ?> h-100 p-2 p-md-3">
                        <div class="d-flex flex-column align-items-center text-center">
                            <div class="icon-pipeline <?php echo e($p['color']); ?> bg-opacity-10 mb-2" style="width: 36px; height: 36px;">
                                <i class="bi bi-circle-fill" style="font-size: 0.5rem;"></i>
                            </div>
                            <h5 class="mb-1 fw-bold <?php echo e($p['color']); ?>"><?php echo e(number_format($p['val'])); ?></h5>
                            <div class="fw-bold text-muted text-uppercase tracking-wider" style="font-size: 0.55rem;">
                                <?php echo e($p['label']); ?></div>
                        </div>
                    </div>
                </a>
            </div>
                        ...
                        <div style="height: 270px; width: 100%; max-width: 300px; position: relative;">
                            ...
                            <div class="position-absolute top-50 start-50 translate-middle text-center"
                                ...
                                <span class="small fw-bold d-block text-uppercase"
                                    style="color:#64748b;opacity:0.8;font-size:0.7rem;">Total</span>
                                <span class="fw-bold display-6" style="color:#3b82f6;font-size:1.5rem;"><?php echo e($total); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-md-4">
            <a href="<?php echo e(route('admin.arsip.index', ['jenis' => 'Produk_Baru'])); ?>" class="text-decoration-none h-100 d-block">
        ...
        <div class="col-6 col-md-4">
            <a href="<?php echo e(route('admin.arsip.index', ['jenis' => 'Produk_Baru', 'ket_process' => 'Done'])); ?>" class="text-decoration-none h-100 d-block">
                <div class="card border-0 shadow-sm rounded-4 h-100 p-3" style="background: #ecfdf5; border-left: 4px solid #10b981 !important;">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="fw-bold text-uppercase text-success" style="font-size: 0.65rem; letter-spacing: 0.5px;">DONE</small>
        ...
        <div class="col-6 col-md-4">
            <a href="<?php echo e(route('admin.arsip.index', ['jenis' => 'Produk_Baru', 'ket_process' => 'Process'])); ?>" class="text-decoration-none h-100 d-block">
    ...
    <div class="row g-2 g-md-3 mb-4">
        <?php
            $cats = [
                ...
                ['label' => 'PRODUK BARU', 'val' => $produkBaruCount, 'code' => 'Produk_Baru', 'color' => '#a855f7'],
            ];
        ?>
        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-6 col-sm-4 col-lg-2">
                <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['jenis_pengajuan' => $c['code']]))); ?>"
                    class="text-decoration-none h-100 d-block">
                    <div class="card-category h-100 p-2 p-md-3">
                        <div class="icon-category-circle" style="background: <?php echo e($c['color']); ?>; width: 36px; height: 36px;">
                            <i class="bi bi-folder2-open" style="font-size: 1rem;"></i>
                        </div>
                        <div class="small fw-bold text-muted mb-1 text-uppercase" style="font-size: 0.55rem;"><?php echo e($c['label']); ?>

                        </div>
                        <div class="cat-count" style="color: <?php echo e($c['color']); ?>; font-size: 1.2rem;">
                            <?php echo e(number_format($c['val'])); ?></div>
                    </div>
                </a>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="fw-bold text-dark" style="font-size:.9rem;">
                                    <?php echo e(optional($a->tgl_pengajuan)->format('d M Y')); ?></div>
                                <div class="small text-muted"><i
                                        class="bi bi-clock me-1 text-primary opacity-75"></i><?php echo e(optional($a->created_at)->format('H:i')); ?>
                            ...
                            <td>
                                <div class="d-flex flex-column gap-1">
                                    <?php if($a->no_registrasi): ?>
                                        <div class="px-2 py-0 rounded border border-info border-opacity-50 text-info font-monospace fw-bold shadow-sm"
                                            style="font-size:0.72rem;width:fit-content;background:#f0f9ff;">
                                    ...
                                    <?php if($a->no_transaksi): ?>
                                        <div class="d-flex align-items-center mt-1">
                                            ...
                                            <span class="text-primary fw-bold font-monospace"
                                                style="font-size:0.75rem;"><?php echo e($a->no_transaksi); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="d-none d-lg-table-cell">
                                <?php
                                    $jc = match ($a->jenis_pengajuan) {
                                        ...
                                        'Produk_Baru' => ['bg' => '#faf5ff', 'text' => '#a855f7'],
                                        default => ['bg' => '#f5f3ff', 'text' => '#6366f1'],
                                    };
                                ?>
                                <span class="px-3 py-1 rounded-pill fw-bold"
                                    style="font-size:0.68rem; background:<?php echo e($jc['bg']); ?>; color:<?php echo e($jc['text']); ?>; border:1px solid <?php echo e($jc['text']); ?>20;">
                                    <?php echo e(strtoupper(str_replace('_', ' ', $a->jenis_pengajuan))); ?>
                            ...
                            <td>
                                ...
                                <div class="px-3 py-1 rounded-pill fw-bold d-flex align-items-center gap-2"
                                    style="font-size:0.68rem; background:<?php echo e($kpC['bg']); ?>; color:<?php echo e($kpC['text']); ?>; border:1.5px solid <?php echo e($kpC['border']); ?>; width:fit-content;">
                                    <div class="rounded-circle" style="width:6px;height:6px;background:<?php echo e($kpC['dot']); ?>;">
                                    </div>
                                ...
                                <div class="d-lg-none mt-2">
                                    <span class="badge"
                                        style="font-size:0.6rem; background:<?php echo e($jc['bg']); ?>; color:<?php echo e($jc['text']); ?>;"><?php echo e(strtoupper(str_replace('_', ' ', $a->jenis_pengajuan))); ?></span>
                                </div>
                            </td>
                            <td class="text-center d-none d-sm-table-cell">
                                <div class="d-flex gap-2 justify-content-center">
                                    <span class="badge rounded-pill bg-success fw-bold px-2"
                                        style="font-size:.72rem;">+<?php echo e((int) $a->total_qty_in); ?></span>
                                    <span class="badge rounded-pill bg-danger fw-bold px-2"
                                        style="font-size:.72rem;">-<?php echo e((int) $a->total_qty_out); ?></span>
                                </div>
                            ...
                            <td class="text-end pe-4 d-none d-md-table-cell">
                                <div class="d-flex flex-column gap-1 align-items-end" style="min-width:200px;">
                                    ...
                                    <?php if($a->adjustItems->count() > 0): ?>
                                        <?php $itemsFound = true; ?>
                                        <?php $__currentLoopData = $a->adjustItems->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item-detail-card-mini w-100">
                                                <div class="fw-bold text-dark font-monospace" style="font-size:.7rem;">
                                                    <?php echo e($item->product_code); ?></div>
                                                <div class="qty-bubble-mini <?php echo e($item->qty_out > 0 ? 'out' : 'in'); ?>">
                                                    <?php echo e($item->qty_out > 0 ? '-' . (int) $item->qty_out : '+' . (int) $item->qty_in); ?>

                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    <?php if(str_contains($a->jenis_pengajuan, 'Mutasi') && $a->mutasiItems->count() > 0): ?>
                                        <?php $itemsFound = true; ?>
                                        <?php $__currentLoopData = $a->mutasiItems->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="item-detail-card-mini w-100">
                                                <div class="fw-bold text-dark font-monospace" style="font-size:.7rem;">
                                                    <?php echo e($item->product_code); ?></div>
                                                <div class="qty-bubble-mini <?php echo e($item->type == 'asal' ? 'out' : 'in'); ?>">
                                                    <?php echo e($item->type == 'asal' ? '-' . (int) $item->qty : '+' . (int) $item->qty); ?>
                                    ...
                                    <?php if(!$itemsFound && $a->keterangan): ?>
                                        <div class="text-muted small fst-italic text-truncate" style="max-width:190px;">
                                            "<?php echo e($a->keterangan); ?>"</div>
                                    <?php endif; ?>
                                    <?php if($a->adjustItems->count() > 2 || $a->mutasiItems->count() > 2): ?>
                                        <small class="text-primary fw-bold mt-1"
                                            style="font-size:.64rem;">+<?php echo e(max($a->adjustItems->count(), $a->mutasiItems->count()) - 2); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const monthData = <?php echo json_encode($monthlyChart, 15, 512) ?>;
            const statusData = <?php echo json_encode($statusChart, 15, 512) ?>;
            const trendByType = <?php echo json_encode($trendByType, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\admin\dashboard\index.blade.php ENDPATH**/ ?>