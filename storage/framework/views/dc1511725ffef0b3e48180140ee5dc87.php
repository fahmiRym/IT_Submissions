                                 ...
                                 <?php if($a->no_doc): ?>
                                     <div class="d-flex align-items-center mb-1 ps-2">
                                          <div class="text-primary fw-extrabold font-monospace" style="font-size: 0.82rem; border-left: 3px solid #0d6efd; padding-left: 8px;">
                                              <?php echo e(strtoupper($a->no_doc)); ?>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="item-detail-card">
                                                <div class="lh-1 pe-2">
                                                    ...
                                                    <?php if($item->panjang || $item->location): ?>
                                                        <div class="mt-1 d-flex gap-1" style="font-size: 0.62rem;">
                                                            <?php if($item->panjang): ?> <span class="badge bg-secondary opacity-75">P: <?php echo e($item->panjang); ?></span> <?php endif; ?>
                                                            <?php if($item->location): ?> <span class="badge bg-light text-dark border" title="<?php echo e($item->location); ?>"><i class="bi bi-geo-alt"></i> Loc</span> <?php endif; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                        ...
                        <td class="text-center pe-4">
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                <button class="btn btn-sm btn-info text-white shadow-sm rounded-3 p-2 d-flex align-items-center" 
                                        ...
                                        <?php echo e(!$a->bukti_scan ? 'disabled' : ''); ?> title="View">
