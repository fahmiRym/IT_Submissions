...
<div class="card border-0 shadow-sm rounded-4 mt-4">
    <div class="card-body p-4">
        ...
        <div class="row g-4">
            <div class="col-md-5">
                ...
                <div class="border rounded-3 d-flex align-items-center justify-content-center bg-light" style="height: 150px;">
                    <?php if(auth()->user()->signature_path): ?>
                        <img src="<?php echo e(auth()->user()->signatureUrl()); ?>" alt="Specimen TTD" style="max-height: 130px; max-width: 100%; object-fit: contain;">
                    <?php else: ?>
                        <span class="text-muted small fst-italic">Belum ada tanda tangan.</span>
                    <?php endif; ?>
                </div>
                <?php if(auth()->user()->signature_path): ?>
                    <form method="POST" action="<?php echo e($action); ?>" class="mt-2" onsubmit="return confirm('Hapus tanda tangan digital?')">
                        <?php echo csrf_field(); ?>
            ...
            <div class="col-md-7">
                <form method="POST" action="<?php echo e($action); ?>" enctype="multipart/form-data" id="formSignature">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\e_arsip\resources\views\partials\_signature_specimen.blade.php ENDPATH**/ ?>