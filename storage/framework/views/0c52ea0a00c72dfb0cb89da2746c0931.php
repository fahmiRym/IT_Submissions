...
<?php $__env->startSection('title', 'IT Submission Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 16px;">
        <div class="card-body p-4">
            <form method="GET" action="<?php echo e(route('superadmin.dashboard')); ?>" class="row g-3 px-1">
                ...
                <div class="col-md-2">
                    ...
                    <select name="jenis_pengajuan" class="form-select bg-light border-0 py-2 rounded-3 shadow-none">
                        <option value="">-- Semua --</option>
                        <?php $__currentLoopData = ['Adjust', 'Mutasi_Billet', 'Mutasi_Produk', 'Internal_Memo', 'Bundel', 'Cancel']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($jenis); ?>" <?php echo e(request('jenis_pengajuan') == $jenis ? 'selected' : ''); ?>>
                                <?php echo e(str_replace('_', ' ', $jenis)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
    ...
    <div class="row g-4 mb-4">
        <!-- Terarsip -->
        <div class="col-md-3">
            <a href="<?php echo e(route('superadmin.arsip.index', array_merge(request()->all(), ['arsip' => 'Done']))); ?>"
                ...
                <div class="card-stat-vibrant bg-gradient-indigo h-100 p-4">
                    ...
                    <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalArsip)); ?></h2>
        ...
        <!-- Total -->
        <div class="col-md-3">
            <a href="<?php echo e(route('superadmin.arsip.index', request()->all())); ?>" class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-blue h-100 p-4">
                    ...
                    <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalPengajuan)); ?></h2>
        ...
        <!-- Selesai -->
        <div class="col-md-3">
            <a href="<?php echo e(route('superadmin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Done']))); ?>"
                class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-green h-100 p-4">
                    ...
                    <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($arsipDone)); ?></h2>
        ...
        <!-- Proses -->
        <div class="col-md-3">
            <a href="<?php echo e(route('superadmin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Process']))); ?>"
                class="text-decoration-none h-100 d-block">
                <div class="card-stat-vibrant bg-gradient-orange h-100 p-4">
                    ...
                    <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($arsipProcess)); ?></h2>
    ...
    <div class="row g-3 mb-4">
        ...
        <?php $__currentLoopData = $proc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-2">
                <a href="<?php echo e(route('superadmin.arsip.index', array_merge(request()->all(), ['ket_process' => $p['db']]))); ?>"
                    class="text-decoration-none h-100 d-block">
                    <div class="card-pipeline <?php echo e($p['color']); ?> h-100 p-3">
                        <div class="d-flex flex-column align-items-center text-center">
                            <div class="icon-pipeline <?php echo e($p['color']); ?> bg-opacity-10 mb-2" style="width: 40px; height: 40px;">
                                <i class="bi bi-circle-fill fs-6"></i>
                            </div>
                            <h4 class="mb-1 fw-bold <?php echo e($p['color']); ?>"><?php echo e(number_format($p['val'])); ?></h4>
                    ...
                    <div style="height: 280px; width: 100%; position: relative;">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center"
                            ...
                            <span class="small fw-bold d-block text-uppercase" style="color: #64748b; opacity: 0.8;">Total
                                Data</span>
                            <span class="fw-bold display-6" style="color: #3b82f6;"><?php echo e($totalPengajuan); ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="col-md-2">
                <a href="<?php echo e(route('superadmin.arsip.index', array_merge(request()->all(), ['jenis_pengajuan' => $c['code']]))); ?>"
                    class="text-decoration-none h-100 d-block">
                    <div class="card-category h-100">
                        <div class="icon-category-circle" style="background: <?php echo e($c['color']); ?>">
                            <i class="bi bi-folder2-open"></i>
                        </div>
                        <div class="small fw-bold text-muted mb-1 text-uppercase"><?php echo e($c['label']); ?></div>
                        <div class="cat-count" style="color: <?php echo e($c['color']); ?>"><?php echo e(number_format($val)); ?></div>
                    </div>
                </a>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $latestArsip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="ps-4">
                                        <span
                                            class="font-monospace fw-bold text-primary small"><?php echo e($submission->no_registrasi ?? '-'); ?></span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-gradient-indigo text-white d-flex align-items-center justify-content-center me-2 shadow-sm"
                                                ...
                                                <?php echo e(substr($submission->admin->name ?? 'U', 0, 1)); ?>

                                            </div>
                                            <div>
                                                <div class="small fw-bold text-dark"><?php echo e($submission->admin->name ?? 'User'); ?></div>
                                                <div class="text-muted" style="font-size: 0.7rem;"><?php echo e($submission->department->name ?? 'Dept'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span
                                            class="badge bg-<?php echo e($sc); ?> bg-opacity-10 text-<?php echo e($sc); ?> border border-<?php echo e($sc); ?> border-opacity-20 rounded-pill px-3 py-1" style="font-size: 0.65rem;">
                                            <?php echo e($submission->ket_process); ?>
            ...
            <div class="card-chart h-100 mb-0">
                ...
                <div class="p-3">
                    <div class="d-flex flex-column gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $recentEdits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-bold text-dark" style="font-size: 0.85rem;"><?php echo e($edit->editor->name ?? 'System'); ?></span>
                                            <small class="text-muted font-monospace" style="font-size: 0.65rem;"><?php echo e($edit->updated_at->diffForHumans()); ?></small>
                                        </div>
                                        <p class="mb-1 text-secondary" style="font-size: 0.75rem; line-height: 1.4;">
                                            Mengubah berkas <span class="fw-bold text-primary"><?php echo e($edit->no_registrasi); ?></span>
                                        </p>
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="badge bg-success bg-opacity-10 text-success rounded-pill" style="font-size: 0.6rem;">UPDATE</span>
                                            <span class="text-muted" style="font-size: 0.65rem;"><i class="bi bi-clock me-1"></i><?php echo e($edit->updated_at->format('H:i')); ?> WIB</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const deptData = <?php echo json_encode($auditByDepartment, 15, 512) ?>;
            ...
            const deptCancel = <?php echo json_encode($deptCancel, 15, 512) ?>;
            const deptAdjust = <?php echo json_encode($deptAdjust, 15, 512) ?>;
            const deptBundel = <?php echo json_encode($deptBundel, 15, 512) ?>;
            const deptMemo = <?php echo json_encode($deptMemo, 15, 512) ?>;
            const deptMutasi = <?php echo json_encode($deptMutasi, 15, 512) ?>;
            ...
            const deptMutasiProduk = <?php echo json_encode($deptMutasiProduk, 15, 512) ?>;
            const deptMutasiBillet = <?php echo json_encode($deptMutasiBillet, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views/superadmin/dashboard/index.blade.php ENDPATH**/ ?>