...
Cancelled No Doc : 1599/<?php echo e(date('m')); ?>/IT/<?php echo e(date('Y')); ?>

Adjust No Doc   : DC/<?php echo e(date('Y')); ?>/<?php echo e(date('m')); ?>/<?php echo e(date('d')); ?>/0100
Mutasi Produk   : RPP/<?php echo e(date('Y')); ?>/<?php echo e(date('m')); ?>/1485
Internal Memo   : IM/<?php echo e(date('Y')); ?>/<?php echo e(date('m')); ?>/1485
</pre>
            ...
            <div class="modal-body px-4 pb-2 pt-3">
                ...
                <div id="sectionCancelResult" class="d-none">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <span
                            class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 px-3 py-2 fw-bold"
                            style="font-size:.8rem;">
                            <i class="bi bi-x-octagon-fill me-1"></i>CANCEL
                        </span>
                        <small class="text-muted">Klik <b>Copy Semua</b> untuk menyalin No Doc + Sub Transaksi
                            sekaligus</small>
                    </div>

                    
                    <div class="mb-3 rounded-3 overflow-hidden border border-2"
                        style="border-color:#86efac !important;">
                        ...
                        <div class="p-3 bg-white">
                            <pre id="resultCopyAll" class="mb-0 fw-bold font-monospace"
                ...
                <div id="sectionNonCancelResult">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-3 rounded-3 d-flex align-items-center justify-content-between gap-3"
                            ...
                            <button type="button"
                                class="btn btn-sm btn-success rounded-pill px-3 flex-shrink-0 shadow-sm"
                    ...
                    <div class="mb-2">
                        ...
                        <div class="p-3 rounded-3 d-flex align-items-center justify-content-between gap-3"
                            ...
                            <button type="button"
                                class="btn btn-sm btn-outline-info rounded-pill px-3 flex-shrink-0 shadow-sm"
...
</div><?php /**PATH C:\laragon\www\e_arsip\resources\views/superadmin/arsip/_arsip_sistem.blade.php ENDPATH**/ ?>