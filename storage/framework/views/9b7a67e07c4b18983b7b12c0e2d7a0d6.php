...
<?php $__env->startSection('title', 'Master Data Unit'); ?>
<?php $__env->startSection('page-title', '📦 Master Unit'); ?>
...
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #10b981, #059669);">
            <h6 class="text-white-50 text-uppercase small fw-bold mb-2">Unit Terdaftar</h6>
            <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalUnit)); ?></h2>
            <div class="mt-2 text-white-50 small font-monospace"><i class="bi bi-box-seam-fill me-1"></i> TOTAL DATA</div>
            <i class="bi bi-box-seam-fill stat-overlay-icon"></i>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #3b82f6, #2563eb);">
            <h6 class="text-white-50 text-uppercase small fw-bold mb-2">Terakhir Ditambahkan</h6>
            <h2 class="mb-0 fw-bold text-white text-truncate" style="font-size:2.2rem; line-height:1.2; padding-top:4px;"><?php echo e($latestUnit ?: '-'); ?></h2>
            <div class="mt-2 text-white-50 small font-monospace"><i class="bi bi-patch-check-fill me-1"></i> LATEST UPDATE</div>
            <i class="bi bi-patch-check-fill stat-overlay-icon"></i>
        </div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr class="<?php echo e(!$u->is_active ? 'opacity-60' : ''); ?>">
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="fw-bold <?php echo e(!$u->is_active ? 'text-decoration-line-through text-muted' : 'text-dark'); ?>"><?php echo e($u->name); ?></span>
                            </div>
                        </td>
                        <td>
                            <?php if($u->is_active): ?>
                        ...
                        <td class="text-muted" style="font-size:0.85rem;">
                            <i class="bi bi-calendar3 me-1 opacity-50"></i><?php echo e($u->created_at?->format('d M Y') ?? '-'); ?>

                        </td>
                        <td class="text-center pe-4">
                            <div class="d-flex justify-content-center gap-2">
                                <form action="<?php echo e(route('superadmin.units.toggle', $u->id)); ?>" method="POST" class="d-inline">
                                ...
                                <button class="btn-act btn-act-edit" title="Edit" onclick="editUnit('<?php echo e($u->id); ?>', '<?php echo e(addslashes($u->name)); ?>')">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
                                <form action="<?php echo e(route('superadmin.units.destroy', $u->id)); ?>" method="POST" class="d-inline"
                                      onsubmit="return confirm('Hapus unit <?php echo e(addslashes($u->name)); ?>?')">
...
<div class="modal fade" id="modalCreate" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <form action="<?php echo e(route('superadmin.units.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    function editUnit(id, name) {
        let url = "<?php echo e(route('superadmin.units.update', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\units\index.blade.php ENDPATH**/ ?>