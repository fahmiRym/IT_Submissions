...
<div class="row justify-content-center">
    <div class="col-xl-8">
        ...
        <div class="mb-4">
            <h4 class="fw-bold text-dark mb-1">✏ Edit User: <?php echo e($user->name); ?></h4>
        ...
        <div class="premium-card">
            <div class="card-body p-4 p-md-5">
                <form method="POST" action="<?php echo e(route('superadmin.users.update', $user->id)); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="department_id" class="form-select premium-input <?php $__errorArgs = ['department_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d->id); ?>" <?php echo e($user->department_id == $d->id ? 'selected' : ''); ?>>
                                    <?php echo e($d->name); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\users\edit.blade.php ENDPATH**/ ?>