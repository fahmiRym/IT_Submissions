<?php $__env->startSection('title', 'Master Data Produk'); ?>
    ...
    <div class="col-xl-8">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                ...
                <form action="<?php echo e(route('superadmin.products.index')); ?>" method="GET" class="d-flex gap-2">
                    <input type="text" name="q" value="<?php echo e(request('q')); ?>" class="form-control form-control-sm bg-light border-0 rounded-pill px-3" placeholder="Cari nama/kode...">
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark" style="font-size: 0.9rem;"><?php echo e($p->name); ?></div>
                                        <div class="font-monospace text-muted" style="font-size: 0.7rem;"><?php echo e($p->code); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td><span class="badge bg-light text-dark border"><?php echo e($p->category ?? '-'); ?></span></td>
                            <td><span class="fw-semibold text-secondary"><?php echo e($p->unit ?? '-'); ?></span></td>
                            <td class="text-center">
                                <form action="<?php echo e(route('superadmin.products.toggle', $p->id)); ?>" method="POST">
                            ...
                            <td class="text-end pe-4">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm rounded-3">
                                        <li><a class="dropdown-item py-2" href="#" data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($p->id); ?>"><i class="bi bi-pencil-square me-2 text-warning"></i>Edit Produk</a></li>
                                        <li><hr class="dropdown-divider"></li>
                                        <li>
                                            <form action="<?php echo e(route('superadmin.products.destroy', $p->id)); ?>" method="POST" onsubmit="return confirm('Hapus produk ini?')">
                                ...
                                <div class="modal fade" id="editModal<?php echo e($p->id); ?>" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 rounded-4 shadow">
                                            ...
                                            <form action="<?php echo e(route('superadmin.products.update', $p->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                                <div class="modal-body p-4 text-start">
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold">KODE PRODUK</label>
                                                        <input type="text" name="code" class="form-control bg-light border-0 py-2 rounded-3" value="<?php echo e($p->code); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold">NAMA PRODUK</label>
                                                        <input type="text" name="name" class="form-control bg-light border-0 py-2 rounded-3" value="<?php echo e($p->name); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold">KATEGORI</label>
                                                        <input type="text" name="category" class="form-control bg-light border-0 py-2 rounded-3" value="<?php echo e($p->category); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold">SATUAN</label>
                                                        <input type="text" name="unit" class="form-control bg-light border-0 py-2 rounded-3" value="<?php echo e($p->unit); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label small fw-bold">KETERANGAN</label>
                                                        <textarea name="description" class="form-control bg-light border-0 rounded-3" rows="3"><?php echo e($p->description); ?></textarea>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views/superadmin/products/index.blade.php ENDPATH**/ ?>