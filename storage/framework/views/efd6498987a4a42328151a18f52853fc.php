<div class="modal fade" id="modalTambahArsip" tabindex="-1" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form method="POST" action="<?php echo e(route('admin.arsip.store')); ?>" enctype="multipart/form-data" id="formTambahArsip">
                <?php echo csrf_field(); ?>
...
BPB-25/12/0327
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="tgl_pengajuan" value="<?php echo e(date('Y-m-d')); ?>" class="form-control bg-white border-0 shadow-sm" required>
                            ...
                            <?php echo $__env->make('partials._approver_select', ['approverUsers' => $approverUsers ?? collect(), 'jenisSelectId' => 'jenisPengajuanTambahAdmin'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
...
</div><?php /**PATH C:\laragon\www\e_arsip\resources\views/admin/arsip/_create.blade.php ENDPATH**/ ?>