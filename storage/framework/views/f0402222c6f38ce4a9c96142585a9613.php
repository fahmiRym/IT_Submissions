...
<head>
    ...
    <title>PDF Viewer | <?php echo e($filename); ?></title>
...
<body>
    ...
    <div class="toolbar">
        <div class="toolbar-title"><?php echo e($filename); ?></div>
        <div class="controls">
            ...
            <a href="<?php echo e($fileUrl); ?>" download class="btn" style="text-decoration: none;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        async function renderPage(pageNum) {
            ...
            <?php if($arsip): ?>
                ...
                <?php if(!empty($wmText)): ?>
                    ...
                    wm.className = 'watermark-overlay <?php echo e($wmClass); ?>';
                    wm.innerText = '<?php echo e($wmText); ?>';
...
</html><?php /**PATH C:\laragon\www\e_arsip\resources\views/vendor/pdfjs/viewer.blade.php ENDPATH**/ ?>