    ...
    <div class="print-container">
        ...
        <div class="doc-header">
            ...
            <div class="qr-wrapper" style="width: 70px;">
                ...
                <div class="qr-label" style="font-family:monospace; color:#111;"><?php echo e($arsip->no_registrasi); ?></div>
            </div>
        </div>
        ...
        <div style="margin-top: -3px; position: relative;">
                    ...
                    <tbody>
                        ...
                        <?php for($i = 0; $i < max(4, count($adjustItems)); $i++): ?>
                            <tr>
                                ...
                                <td><?php echo e($adjustItems[$i]->lot ?? ''); ?></td>
                                <td><?php echo e($adjustItems[$i]->location ?? ''); ?></td>
                                <td><?php echo e($adjustItems[$i]->odoo ?? ''); ?></td>
                                <td><?php echo e($adjustItems[$i]->fisik ?? ''); ?></td>
            ...
            <?php if($isProdukBaru): ?>
                <table class="main-table">
                    ...
                    <tbody>
                        <?php $produkBaruItems = $arsip->produkBaruItems ?? []; ?>
                        <?php for($i = 0; $i < max(4, count($produkBaruItems)); $i++): ?>
                            <tr>
                                <td style="height: 18px;"><?php echo e($produkBaruItems[$i]->product_code ?? ''); ?></td>
                                <td style="text-align: left;"><?php echo e($produkBaruItems[$i]->product_name ?? ''); ?></td>
                                <td><?php echo e($produkBaruItems[$i]->tipe_produk ?? ''); ?></td>
                                <td style="text-align: left;"><?php echo e($produkBaruItems[$i]->kategori ?? ''); ?></td>
                                <td><?php echo e($produkBaruItems[$i]->satuan ?? ''); ?></td>
                                <td><?php echo e($produkBaruItems[$i]->status_approval ?? ''); ?></td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
                </table>
        ...
        <div style="margin-top: 14px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <?php if($isAdjust): ?>
                <table class="main-table" style="margin-top: 5px;">
                    ...
                    <tbody>
                        <tr>
                            <td style="height: 22px; font-weight: 700;"><?php echo e($arsip->tindakan_in ?? ''); ?></td>
                            <td style="text-align: left;"><?php echo e($arsip->ket_tindakan_in ?? ''); ?></td>
                            <td style="font-weight: 700;"><?php echo e($arsip->tindakan_out ?? ''); ?></td>
                            <td style="text-align: left;"><?php echo e($arsip->ket_tindakan_out ?? ''); ?></td>
                        </tr>
            ...
            <div class="ruled"
                ...
                <?php if(!empty(trim($arsip->tindakan))): ?>
                    <div style="font-weight: bold; white-space: pre-wrap;">TINDAKAN: <?php echo e(trim($arsip->tindakan)); ?></div>
                <?php endif; ?>
                <?php if(!empty(trim($arsip->catatan_it))): ?>
                    <div style="font-weight: bold; white-space: pre-wrap; margin-top: 5px;">CATATAN IT: <?php echo e(trim($arsip->catatan_it)); ?></div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="footer-section" style="page-break-inside: avoid; break-inside: avoid;">
            ...
            <table class="signature-table">
                ...
                <tr>
                    <td style="vertical-align: bottom;">
                        <div style="min-height:48px;"><?php echo $renderSig($sigPemohon); ?></div>
                    ...
                    <?php if($isAdjust): ?>
                        <td style="width: 20%; vertical-align: bottom;">
                            <div style="min-height:48px;"><?php echo $renderSig($sigSPV ?: $sigKabag); ?></div>
                            <div style="font-weight: 800; font-size: 10px;">SPV / Kabag</div>
                            <div style="font-size: 8px; font-style: italic;">(Tanda Tangan dan Nama Jelas)</div>
                        </td>
                        <td style="width: 20%; vertical-align: bottom;">
                            <div style="min-height:48px;"><?php echo $renderSig($sigManager); ?></div>
                            <div style="font-weight: 800; font-size: 10px;">Manager</div>
                            <div style="font-size: 8px; font-style: italic;">(Tanda Tangan dan Nama Jelas)</div>
                        </td>
                        <td style="width: 20%; vertical-align: bottom;">
                            <div style="min-height:48px;"><?php echo $renderSig($sigAccounting); ?></div>
                            <div style="font-weight: 800; font-size: 10px;">Accounting</div>
                            <div style="font-size: 8px; font-style: italic;">(Tanda Tangan dan Nama Jelas)</div>
                        </td>
                    <?php else: ?>
                        <td style="width: 20%; vertical-align: bottom;">
                            <div style="min-height:48px;"><?php echo $renderSig($sigSPV); ?></div>
                            <div style="font-weight: 800; font-size: 10px;">SPV</div>
                            <div style="font-size: 8px; font-style: italic;">(Tanda Tangan dan Nama Jelas)</div>
                        </td>
                        <td style="width: 20%; vertical-align: bottom;">
                            <div style="min-height:48px;"><?php echo $renderSig($sigKabag); ?></div>
                    ...
                    <?php endif; ?>
                    <td style="vertical-align: bottom;">
                        <div style="min-height:48px;"><?php echo $renderSig($sigIT); ?></div>
            ...
            <?php if($arsip->signatures->count() > 0): ?>
                <?php $signedNames = $arsip->signatures->pluck('role_label')->all(); ?>
                <div style="margin-top:4px; padding:4px 8px; border:1px dashed #1d4ed8; border-radius:4px; font-size:8.5px; font-weight:700; color:#1e293b; display:flex; justify-content:space-between; align-items:center;">
                    <span><i style="color:#1d4ed8;">✓</i> Dokumen ini ditandatangani secara digital (<?php echo e(implode(', ', $signedNames)); ?>). Scan QR di pojok kanan atas untuk verifikasi.</span>
                    <?php if($arsip->verify_token): ?>
                        <span style="font-family:monospace; color:#1d4ed8;">#<?php echo e(\Illuminate\Support\Str::limit($arsip->verify_token, 12, '')); ?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            new QRCode(document.getElementById("qrcode"), {
                text: "<?php echo e($arsip->verify_token ? route('verify.show', $arsip->verify_token) : $arsip->no_registrasi); ?>",
                width: 62,
                height: 62,
                colorDark: "#000000",
                colorLight: "#ffffff",
