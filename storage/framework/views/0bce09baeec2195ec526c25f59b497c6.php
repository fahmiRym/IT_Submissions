...
<?php $__env->startSection('title', 'Master Data Manager'); ?>
<?php $__env->startSection('page-title', '🧑‍💼 Master Manager'); ?>
...
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #4f46e5, #3730a3);">
            ...
            <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalManager)); ?></h2>
    ...
    <div class="col-md-6">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #f59e0b, #d97706);">
            ...
            <h2 class="mb-0 fw-bold text-white text-truncate" style="font-size:2.2rem; line-height:1.2; padding-top:4px;"><?php echo e($latestManager ?: '-'); ?></h2>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="<?php echo e(!$m->is_active ? 'opacity-60' : ''); ?>">
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <div class="avatar-circle bg-indigo-soft text-primary" style="background: rgba(99,102,241,0.1);">
                                    <?php echo e(strtoupper(substr($m->name, 0, 1))); ?>

                                </div>
                                <span class="fw-bold <?php echo e(!$m->is_active ? 'text-decoration-line-through text-muted' : 'text-dark'); ?>"><?php echo e($m->name); ?></span>
                            </div>
                        </td>
                        <td>
                            <?php if($m->is_active): ?>
                        ...
                        <td class="text-muted" style="font-size:0.85rem;">
                            <i class="bi bi-calendar3 me-1 opacity-50"></i><?php echo e($m->created_at?->format('d M Y') ?? '-'); ?>

                        </td>
                        <td class="text-center pe-4">
                            <div class="d-flex justify-content-center gap-2">
                                <form action="<?php echo e(route('superadmin.managers.toggle', $m->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                    <button type="submit" title="<?php echo e($m->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>"
                                        class="btn-act <?php echo e($m->is_active ? 'btn-act-toggle-off' : 'btn-act-toggle-on'); ?>">
                                        <i class="bi <?php echo e($m->is_active ? 'bi-slash-circle-fill' : 'bi-check-circle-fill'); ?>"></i>
                                    </button>
                                </form>
                                <button class="btn-act btn-act-edit" title="Edit" onclick="editManager('<?php echo e($m->id); ?>', '<?php echo e(addslashes($m->name)); ?>')">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
                                <form action="<?php echo e(route('superadmin.managers.destroy', $m->id)); ?>" method="POST" class="d-inline"
                                      onsubmit="return confirm('Hapus manager <?php echo e(addslashes($m->name)); ?>?')">
...
<div class="modal fade" id="modalCreate" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <form action="<?php echo e(route('superadmin.managers.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    function editManager(id, name) {
        let url = "<?php echo e(route('superadmin.managers.update', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\managers\index.blade.php ENDPATH**/ ?>