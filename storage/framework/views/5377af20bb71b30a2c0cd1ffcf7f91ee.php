            ...
            <div class="card-body p-0 pb-4">
                ...
                <div class="px-4 py-3">
                    <div class="row g-3">
                        ...
                        <div class="col-4">
                            <div class="stat-box">
                                <div class="stat-value"><?php echo e($stats['total_arsip']); ?></div>
                ...
                <form method="POST" action="<?php echo e(route('superadmin.profile.update')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control premium-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('name', $user->name)); ?>" required placeholder="Masukkan nama lengkap">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" class="form-control premium-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php echo $__env->make('partials._signature_specimen', ['action' => route('superadmin.profile.signature')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function cancelPhotoUpload() {
        ...
        <?php else: ?>
            if (currentPhoto) currentPhoto.outerHTML = `<div class="avatar-initial" id="avatarInitial"><?php echo e(substr(strtoupper($user->name), 0, 1)); ?></div>`;
        <?php endif; ?>
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\superadmin\profile\index.blade.php ENDPATH**/ ?>