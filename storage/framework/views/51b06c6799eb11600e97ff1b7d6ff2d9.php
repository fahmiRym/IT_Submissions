    ...
    <div class="card-body p-4">
        <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="row g-3">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                ...
                <input type="date" name="start_date" value="<?php echo e(request('start_date')); ?>" class="form-control bg-light border-0 py-2 rounded-3 shadow-none">
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <label class="small fw-bold text-muted mb-2">SAMPAI TANGGAL</label>
                <input type="date" name="end_date" value="<?php echo e(request('end_date')); ?>" class="form-control bg-light border-0 py-2 rounded-3 shadow-none">
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
            ...
            <div class="col-12 col-lg-5 d-flex gap-2 align-items-end mt-3 mt-lg-0">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-light border bg-white shadow-sm py-2 px-3 rounded-3" title="Reset Filter">
...
<div class="row g-3 g-lg-4 mb-4">
    ...
    <div class="col-6 col-lg-3">
        <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Review']))); ?>" class="text-decoration-none h-100 d-block">
    ...
    <div class="col-6 col-lg-3">
        <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Process']))); ?>" class="text-decoration-none h-100 d-block">
    ...
    <div class="col-6 col-lg-3">
        <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => 'Done']))); ?>" class="text-decoration-none h-100 d-block">
...
<div class="row g-2 g-md-3 mb-4">
    ...
    <div class="col-6 col-sm-4 col-lg-2">
        <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['ket_process' => $p['db']]))); ?>" class="text-decoration-none h-100 d-block">
            <div class="card-pipeline <?php echo e($p['color']); ?> h-100 p-2 p-md-3">
                <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="fw-bold text-muted text-uppercase tracking-wider" style="font-size: 0.55rem;"><?php echo e($p['label']); ?></div>
                </div>
            </div>
        </a>
    </div>
...
<div class="row g-2 g-md-3 mb-4">
    ...
    <div class="col-6 col-sm-4 col-lg-2">
        <a href="<?php echo e(route('admin.arsip.index', array_merge(request()->all(), ['jenis_pengajuan' => $c['code']]))); ?>" class="text-decoration-none h-100 d-block">
            <div class="card-category h-100 p-2 p-md-3">
                ...
                <div class="small fw-bold text-muted mb-1 text-uppercase" style="font-size: 0.55rem;"><?php echo e($c['label']); ?></div>
                <div class="cat-count" style="color: <?php echo e($c['color']); ?>; font-size: 1.2rem;"><?php echo e(number_format($c['val'])); ?></div>
            </div>
        </a>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="card-chart mb-4">
    <div class="card-header-chart d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo e(route('admin.arsip.index')); ?>" class="btn btn-sm btn-light text-primary fw-bold rounded-pill px-3 shadow-sm">
            Lihat Semua
        </a>
    </div>
    <div class="table-responsive">
        <table class="table table-modern mb-0">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $arsips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td class="ps-4">
                        <div class="fw-bold text-dark" style="font-size:.9rem;"><?php echo e(optional($a->tgl_pengajuan)->format('d M Y')); ?></div>
                        <div class="small text-muted"><i class="bi bi-clock me-1 text-primary opacity-75"></i><?php echo e(optional($a->created_at)->format('H:i')); ?></div>
                    </td>
                    <td>
                        <div class="d-flex flex-column gap-1">
                            ...
                            <?php if($a->no_transaksi): ?>
                                <div class="d-flex align-items-center mt-1">
                                    ...
                                    <span class="text-primary fw-bold font-monospace" style="font-size:0.75rem;"><?php echo e($a->no_transaksi); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </td>
                    <td class="d-none d-lg-table-cell">
                        ...
                        ?>
                        <span class="px-3 py-1 rounded-pill fw-bold" style="font-size:0.68rem; background:<?php echo e($jc['bg']); ?>; color:<?php echo e($jc['text']); ?>; border:1px solid <?php echo e($jc['text']); ?>20;">
                    ...
                    <td>
                        ...
                        <div class="px-3 py-1 rounded-pill fw-bold d-flex align-items-center gap-2"
                            ...
                            <div class="rounded-circle" style="width:6px;height:6px;background:<?php echo e($kpC['dot']); ?>;"></div>
                            <?php echo e(strtoupper($a->ket_process)); ?>

                        </div>
                        <div class="d-lg-none mt-2">
                             <span class="badge" style="font-size:0.6rem; background:<?php echo e($jc['bg']); ?>; color:<?php echo e($jc['text']); ?>;"><?php echo e(strtoupper(str_replace('_', ' ', $a->jenis_pengajuan))); ?></span>
                        </div>
                    </td>
                    <td class="text-center d-none d-sm-table-cell">
                        <div class="d-flex gap-2 justify-content-center">
                            <span class="badge rounded-pill bg-success fw-bold px-2" style="font-size:.72rem;">+<?php echo e((int)$a->total_qty_in); ?></span>
                            <span class="badge rounded-pill bg-danger fw-bold px-2" style="font-size:.72rem;">-<?php echo e((int)$a->total_qty_out); ?></span>
                        </div>
                    ...
                    <td class="text-end pe-4 d-none d-md-table-cell">
                        <div class="d-flex flex-column gap-1 align-items-end" style="min-width:200px;">
                            ...
                            <?php if($a->adjustItems->count() > 0): ?>
                                ...
                                <?php $__currentLoopData = $a->adjustItems->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="item-detail-card-mini w-100">
                                        <div class="fw-bold text-dark font-monospace" style="font-size:.7rem;"><?php echo e($item->product_code); ?></div>
                            ...
                            <?php if(!$itemsFound && $a->keterangan): ?>
                                <div class="text-muted small fst-italic text-truncate" style="max-width:190px;">"<?php echo e($a->keterangan); ?>"</div>
                            <?php endif; ?>
                            <?php if($a->adjustItems->count() > 2 || $a->mutasiItems->count() > 2): ?>
                                <small class="text-primary fw-bold mt-1" style="font-size:.64rem;">+<?php echo e(max($a->adjustItems->count(), $a->mutasiItems->count()) - 2); ?> lainnya</small>
                            <?php endif; ?>
                        </div>
                    </td>
                </tr>
