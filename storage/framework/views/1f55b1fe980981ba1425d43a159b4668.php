...
<?php $__env->startSection('title', 'Master Data Departemen'); ?>
...
<div class="row g-4 mb-4">
    <div class="col-md-4">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #818cf8, #4f46e5);">
            ...
            <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalDept)); ?></h2>
    ...
    <div class="col-md-4">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #34d399, #059669);">
            ...
            <h2 class="mb-0 fw-bold display-5 text-white"><?php echo e(number_format($totalUser)); ?></h2>
    ...
    <div class="col-md-4">
        <div class="card-stat-vibrant h-100 p-4" style="background: linear-gradient(135deg, #fbbf24, #d97706);">
            ...
            <h2 class="mb-0 fw-bold text-white text-truncate" style="font-size:2.2rem; line-height:1.2; padding-top:4px;"><?php echo e($latestDept ?: '-'); ?></h2>
        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr class="<?php echo e(!$d->is_active ? 'opacity-60' : ''); ?>">
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="fw-bold <?php echo e(!$d->is_active ? 'text-decoration-line-through text-muted' : 'text-dark'); ?>"><?php echo e($d->name); ?></span>
                            </div>
                        </td>
                        <td>
                            <?php if($d->is_active): ?>
                        ...
                        <td class="text-muted" style="font-size:0.85rem;">
                            <i class="bi bi-calendar3 me-1 opacity-50"></i><?php echo e($d->created_at?->format('d M Y') ?? '-'); ?>

                        </td>
                        <td class="text-center pe-4">
                            <div class="d-flex justify-content-center gap-2">
                                <form action="<?php echo e(route('superadmin.departments.toggle', $d->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                                    <button type="submit" title="<?php echo e($d->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>"
                                        class="btn-act <?php echo e($d->is_active ? 'btn-act-toggle-off' : 'btn-act-toggle-on'); ?>">
                                        <i class="bi <?php echo e($d->is_active ? 'bi-slash-circle-fill' : 'bi-check-circle-fill'); ?>"></i>
                                    </button>
                                </form>
                                <button class="btn-act btn-act-edit" title="Edit" onclick="editDept('<?php echo e($d->id); ?>', '<?php echo e(addslashes($d->name)); ?>')">
                                    <i class="bi bi-pencil-fill"></i>
                                </button>
                                <form action="<?php echo e(route('superadmin.departments.destroy', $d->id)); ?>" method="POST" class="d-inline"
                                      onsubmit="return confirm('Hapus departemen <?php echo e(addslashes($d->name)); ?>?')">
...
<div class="modal fade" id="modalCreate" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            ...
            <form action="<?php echo e(route('superadmin.departments.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    function editDept(id, name) {
        let url = "<?php echo e(route('superadmin.departments.update', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\departments\index.blade.php ENDPATH**/ ?>