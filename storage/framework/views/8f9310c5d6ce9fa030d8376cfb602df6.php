...
<?php $__env->startSection('title', 'Backup & Restore Data | IT Submission'); ?>
<?php $__env->startSection('page-title', 'Backup & Restore Data'); ?>
...
<div class="alert border-0 rounded-4 shadow-sm d-flex align-items-center gap-3 mb-4" style="background:#f0fdf4; border-left: 4px solid #22c55e !important;">
    ...
    <div class="flex-grow-1">
        ...
        <div class="small text-muted"><?php echo e(session('success')); ?></div>
    </div>
...
<div class="d-flex align-items-center gap-3 mb-4">
    ...
    <a href="<?php echo e(route('superadmin.arsip.index')); ?>" class="btn btn-light rounded-pill ms-auto px-4 fw-bold shadow-sm">
        ...
        <div class="backup-card h-100">
            ...
            <div class="backup-card-body">
                ...
                <div class="d-flex flex-column gap-3 mb-4">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$n, $t, $d, $c, $i]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex align-items-start gap-3">
                        <div class="step-badge" style="background:<?php echo e($c); ?>20; color:<?php echo e($c); ?>;"><?php echo e($n); ?></div>
                        <div>
                            <div class="fw-bold text-dark" style="font-size:.9rem;"><?php echo e($t); ?></div>
                            <div class="text-muted small"><?php echo e($d); ?></div>
                        </div>
                    </div>
                ...
                <form action="<?php echo e(route('superadmin.backup.export')); ?>" method="GET" id="exportForm">
    ...
    <div class="col-lg-6">
        <div class="backup-card h-100">
            ...
            <div class="backup-card-body">
                ...
                <form action="<?php echo e(route('superadmin.backup.import')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e_arsip\resources\views\superadmin\backup\index.blade.php ENDPATH**/ ?>