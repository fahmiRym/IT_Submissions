...
<body>
    ...
    <div class="og-modal-overlay" id="ogImageModal" role="dialog" aria-modal="true" aria-label="OG Image Preview">
        <div class="og-modal">
            ...
            <div class="og-modal-body">
                <img id="ogImageModalImg" src="<?php echo e(asset('img/og-image.png')); ?>" alt="OG Image" />
            </div>
        </div>
    </div>
    ...
    <div class="glass-card animate__animated animate__fadeInUp">
        ...
        <div class="side-info">
            ...
            <img id="ogImageGuide" src="<?php echo e(asset('img/og-image.png')); ?>" alt="OG Image" style="width: 100%; height: auto; border-radius: 1rem; object-fit: contain;" class="mb-4" role="button" tabindex="0" aria-label="Klik untuk memperbesar OG image">
        ...
        <div class="side-form">
            ...
            <form method="POST" action="<?php echo e(route('login.process')); ?>">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Company Logo" style="height: 56px; width: auto;" class="mb-3">
...
<?php /**PATH C:\laragon\www\e_arsip\resources\views/auth/login.blade.php ENDPATH**/ ?>